...
type Topic struct {
	...
	Id               int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Name             string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	NumberOfMessages int64                  `protobuf:"varint,3,opt,name=numberOfMessages,proto3" json:"numberOfMessages,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Topic) GetNumberOfMessages() int64 {
	if x != nil {
...
const file_razpravljalnica_razpravljalnica_proto_rawDesc = "" +
	...
	"\x10numberOfMessages\x18\x03 \x01(\x03R\x10numberOfMessages\"\xb2\x01\n" +
	"\aMessage\x12\x0e\n" +
