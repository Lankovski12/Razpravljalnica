...
type MessageBoardClient interface {
	...
	FindUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *messageBoardClient) FindUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type MessageBoardServer interface {
	...
	FindUser(context.Context, *CreateUserRequest) (*emptypb.Empty, error)
	// Creates a new topic to which users can post messages
...
func (UnimplementedMessageBoardServer) FindUser(context.Context, *CreateUserRequest) (*emptypb.Empty, error) {
...
func _MessageBoard_FindUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageBoardServer).FindUser(ctx, req.(*CreateUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
